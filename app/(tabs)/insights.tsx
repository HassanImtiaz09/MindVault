...
export default function InsightsScreen() {
  ...
  return (
    <CinematicScreen screenName="insights">
      ...
      {tab === "summary" ? (
        <ScrollView contentContainerStyle={{ paddingBottom: 40 }} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#FFD700" />}>
                    ...
                    {Object.entries(stats.byType).map(([type, count]) => {
                      ...
                      return (
                        <LinearGradient key={type} colors={[`${c}15`, `${c}08`]} style={styles.typeItem}>
                          ...
                          <Text style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", textTransform: "capitalize" }}>{type}</Text>
                        </LinearGradient>
                      );
                    })}
                  </View>
        ...
        <View style={{ flex: 1 }}>
          {graphQuery.isLoading ? (
            ...
            <View style={styles.emptyGraph}>
              ...
              <Text style={{ color: "rgba(255,255,255,0.4)", fontSize: 14, textAlign: "center", marginTop: 4, paddingHorizontal: 32 }}>
...
const styles = StyleSheet.create({
  ...
  loadingText: { color: "rgba(255,255,255,0.4)", marginTop: 12 },
  ...
  topicLabel: { width: 90, fontSize: 13, color: "rgba(255,255,255,0.6)" },
  topicBarContainer: { flex: 1, height: 8, borderRadius: 4, backgroundColor: "rgba(255,255,255,0.04)", overflow: "hidden" },
